...
$BuildRoot = Join-Path $InstallerRoot "build/SOP分析平台_Windows"
...
$Exclude = @(".venv", "__pycache__", ".git", "installer/build", "installer/dist")
Get-ChildItem -LiteralPath $ProjectRoot -Force | Where-Object { $Exclude -notcontains $_.Name } | ForEach-Object {
