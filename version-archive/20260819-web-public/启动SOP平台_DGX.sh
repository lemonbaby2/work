...
# Camera 3 reads its complete RTSP URL from config/network_cameras.json. Set
# SOP_CAMERA_SOURCE_2 for a temporary现场 override without editing the package.
export SOP_CAMERA_SOURCE_2="${SOP_CAMERA_SOURCE_2:-}"
export SOP_RTSP_TRANSPORT="${SOP_RTSP_TRANSPORT:-tcp}"
